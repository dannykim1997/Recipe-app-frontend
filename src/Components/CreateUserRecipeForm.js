...
export default class AddRecipeForm extends Component {
    ...
    submitRecipe = (e) => {
        ...
        this.props.createUserRecipe(recipe)
    }
    ...
    return (
        <ThemeProvider theme={theme}>
            <div className='buttonPadding'>
                <Button onClick={() => this.handleViewForm()} variant='contained' color='primary'>create recipe</Button>
                {this.state.viewForm ? 
                    <Form onSubmit={(e) => this.submitRecipe(e)} className='buttonPadding'>
